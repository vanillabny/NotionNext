...
const BLOG = {
  API_BASE_URL: process.env.API_BASE_URL || 'https://vanillabny.notion.site/api/v3', // API默认请求地址,可以配置成自己的地址例如：https://[xxxxx].notion.site/api/v3
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'vanillabny', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '流水今日，明月前身。', // 作者简介
  ...
  GREETING_WORDS:
    ...
    '远路谢无名山歌,岭上云俞唱俞清澈,我恍然才惊觉，已留久当行车',
