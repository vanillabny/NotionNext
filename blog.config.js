...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '明明明明月是前身。, 照彻大千清似水，,也曾照彻微尘。',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || true, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '白鸟萤', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '捡一颗星星给你✨', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://vanillastar.icu/', // 网站地址
